...
public class SideImageViewStateAdapterDelegate extends ViewStateAdapterDelegate<SideImageViewStateAdapterDelegate.ViewState,SideImageViewStateAdapterDelegate.ViewHolder> {
    private final ImageLoader imageLoader;

    public SideImageViewStateAdapterDelegate(ImageLoader imageLoader) {
    ...
    protected ViewHolder onCreateViewHolder(@NonNull ViewGroup parent) {
        return new ViewHolder(viewItemForViewHolder(parent, R.layout.cell_side_image));
    }
    ...
    public static abstract class ViewState implements com.urizev.birritas.view.common.ViewState {
        ...
        public static ViewState create(String imageUrl) {
            return new AutoValue_SideImageViewStateAdapterDelegate_ViewState(imageUrl);
        }
    }
}
