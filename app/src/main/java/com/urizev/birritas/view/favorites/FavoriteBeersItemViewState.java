...
public abstract class FavoriteBeersItemViewState implements ViewState {
    ...
    public static FavoriteBeersItemViewState create(String title, String imageUrl, String style, String brewedBy, String ibuValue, String abvValue) {
        return new AutoValue_FavoriteBeersItemViewState(title, imageUrl, style, brewedBy, ibuValue, abvValue);
    }
}
