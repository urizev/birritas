...
public class HeaderViewStateAdapterDelegate extends ViewStateAdapterDelegate<HeaderViewStateAdapterDelegate.ViewState,HeaderViewStateAdapterDelegate.ViewHolder> {
    @Override
    ...
    protected ViewHolder onCreateViewHolder(@NonNull ViewGroup parent) {
        return new ViewHolder(viewItemForViewHolder(parent, R.layout.cell_header));
    }
    ...
    public static abstract class ViewState implements com.urizev.birritas.view.common.ViewState {
        ...
        public static ViewState create(String title) {
            return new AutoValue_HeaderViewStateAdapterDelegate_ViewState(title);
        }
    }
}
